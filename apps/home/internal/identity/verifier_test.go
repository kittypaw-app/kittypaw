...
func TestMemoryCredentialVerifierVerifiesSeededAPIClient(t *testing.T) {
	...
	want := APIClientClaims{
		Subject:   "user_1",
		Audiences: []string{AudienceKittyHome},
...
func TestMemoryCredentialVerifierValidatesAPIClientSeeds(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "missing kittyhome audience", token: "api_secret", claims: withAPIAudiences(valid, []string{AudienceKittyAPI})},
		{name: "legacy kittyhome audience", token: "api_secret", claims: withAPIAudiences(valid, []string{"kittyhome"})},
...
func TestMemoryCredentialVerifierValidatesDeviceSeeds(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "empty token", token: "", claims: valid},
		{name: "missing kittyhome audience", token: "dev_secret", claims: withDeviceAudiences(valid, []string{AudienceKittyAPI})},
		{name: "legacy kittyhome audience", token: "dev_secret", claims: withDeviceAudiences(valid, []string{"kittyhome"})},
...
func TestMemoryCredentialVerifierAcceptsMultiAudienceClaims(t *testing.T) {
	...
	claims := APIClientClaims{
		Subject:   "user_1",
		Audiences: []string{AudienceKittyAPI, AudienceKittyHome},
		Version:   CredentialVersion1,
		Scopes:    []Scope{ScopeChatRelay, ScopeModelsRead},
		UserID:    "user_1",
		DeviceID:  "dev_1",
