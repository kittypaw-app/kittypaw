...
Projects Job Runtime Phase 1.5 구현과 disposable repo live smoke 및 review hardening 은 완료했고, 외부 리뷰/릴리즈 대기 상태다.

- `make test-ci` 통과: code 변경 기준 `9392a45`; 이후 변경은 TASKS 기록만.
- [ ] Review Project Job Runtime Phase 1.5 implementation.
