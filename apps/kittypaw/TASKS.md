...
- [ ] **T1: store/runtime/API/tool/UI 구현** — PTY Job mode, input forwarding, transcript events, web controls.
- [ ] **T2: 검증 및 리뷰** — `go test ./store ./engine ./server -count=1`, `make test-ci`, opt-in `KITTYPAW_LIVE_PTY=1` smoke, review follow-up.
