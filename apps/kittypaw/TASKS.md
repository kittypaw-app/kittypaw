...
- [x] **T0**: 구현 계획 작성, 기존 Workspace/Kanban 영향 범위 확인, 마이그레이션 전략 확정 (`e518a59`).
- [x] **T1**: DB/store 모델 추가 — projects, tickets, ticket actions/messages, jobs, drivers, staff assignments, conversation scope (`9dd6b03`, `7718bb3`).
...
- [x] **T7**: 회귀, E2E, LLM 호출 포함 전수테스트 경로 정리.
