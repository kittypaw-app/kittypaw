...
import (
	...
	"github.com/kittypaw-app/kittyspace/internal/config"
)
...
func TestUnixSocketPath(t *testing.T) {
	tests := []struct {
		...
		{in: "unix:/run/kittyspace.sock", path: "/run/kittyspace.sock", ok: true},
		{in: "/tmp/kittyspace.sock", path: "/tmp/kittyspace.sock", ok: true},
