...
func TestIssueDeviceJWT_RoundTrip(t *testing.T) {
	...
	claims := testfixture.DeviceClaims{
		UserID:   "user-abc",
		DeviceID: "dev-xyz",
		Audience: []string{"https://chat.kittypaw.app", "https://space.kittypaw.app"},
	...
	if len(got.Aud) != 2 || got.Aud[0] != "https://chat.kittypaw.app" || got.Aud[1] != "https://space.kittypaw.app" {
		t.Fatalf("aud = %v, want [https://chat.kittypaw.app https://space.kittypaw.app]", got.Aud)
	}
