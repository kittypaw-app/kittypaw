...
#   - aud contains API, Chat, and Space URL-form audiences during migration
...
if printf '%s' "$PAYLOAD" | jq -e '
    ...
    and (has("uid") | not)
    and ((.aud   // []) | index("https://api.kittypaw.app") != null and index("https://chat.kittypaw.app") != null and index("https://space.kittypaw.app") != null)
